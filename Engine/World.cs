...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Item(ITEM_ID_ADVENTURER_PASS, "Adventurer pass", "Adventurers passes"));
        }
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster gaintSpider = new Monster(MONSTER_ID_GIANT_SPIDER, "Giant spider", 20, 5, 40, 10, 10);
            gaintSpider.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SPIDER_FANG), 75, false));
            gaintSpider.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SPIDER_SILK), 25, true));
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistGarden = new Location(LOCATION_ID_ALCHEMIST_GARDEN, "Alchemist garden", "Many plants are growing here.");
            ...
            Location bridge = new Location(LOCATION_ID_BRIDGE, "Bridge", "A stone bridge crosses the wide river.");
